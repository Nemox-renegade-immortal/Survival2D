...
public sealed class Enemy : Entity
{
    ...
    public float EffectiveMoveSpeed => MoveSpeed * (BuffTimer > 0f ? 1.28f : 1f);

    public static Enemy Create(EnemyKind kind, Vector2 position, int wave)
    {
        switch (kind)
        {
